...
In contrast, for the stomata-open scenario ($\lambda$ = `r round(exp(0.4188939),2)`), the population is increasing more slowly. Even with no mortality, it would require a `r abs(round((1-(1/exp(0.4188939)))*100, 2))`% mortality per generation to remain stable..

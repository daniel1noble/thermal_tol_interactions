...
p1 = ggplot(sims_closed, aes(x = time, y = N, colour = sim)) +
  ...
  scale_colour_viridis_d() + theme(axis.text = element_text(size = 12), axis.title = element_text(size = 14)) +   annotation_custom(closed, xmin = 5, xmax = 9, ymin = 500, ymax = 8000) + ylim(0, 12000)

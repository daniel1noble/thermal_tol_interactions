...
## TO CHECK. Grasshoppers underground so maybe set so they cannot burrow which explains why they are the same temperature. Can also adjust the time to capture a spot when they diverse in Tb.

...
# Rerun the models. Note that the parameters as the same as  
...
# We first need to load the DEB model parameters. These are estimated using MatLab. We've already estimated these so we'll simply just load them into R.
...
```{r, grasshopper_params_box1_2}
#| label: grasshopper_params_box1_2
#| echo: true
#| warning: false
#| message: false
...
# Inital state for DEB model. Note that DEB can ve turned off and only heat and water budget models will be used so some parameters are not needed if DEB is off.
...
Run the biophysical-physiological model species A with some adjustments based on hypothetical differences between the species. 
  ...
  ecto <- ectotherm( Ww_g = Ww_g,
               ...
               metab_mode = 1, # turns on hemimetabolous model, abp
                    ...
                    kap_R = kap.R,
                     ...
                     E_Hj = E.Hj * fract ^ 3,
                      h_a = h.a / (24 ^ 2),
                      s_G = 0.0779,   # Gompertz stress coefficient, from Debber
                      E_0 = E.0 * fract ^ 4,
                     mu_E = mu.E,
                      d_V = d.V,
                      d_E = d.E,
               ...
               clutchsize = clutchsize,
                 ...
                 S_instar = rep(s.1, stages),
                      L_b = 0.09, # structural length at birth (cm),
...
Run the biophysical-physiological model again, but for species B which uses different parameters to capture the different life histories of the species.

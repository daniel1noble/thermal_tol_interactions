...
We can see from @fig-ricker_simulation that when stomata are able to respond  to close grasshoppers are expected to maintain a stable population size, whereas if we have stomata remaining open we expect the population to collapse over time as microhabiats become less suitable for growth and reproduction.

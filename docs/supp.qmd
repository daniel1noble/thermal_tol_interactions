...
This is the code for reproducing the examples for the manuscript:
...
It demonstrates how to couple models from different disciplines to predict the impacts of extreme heat on plant-insect interactions. Please get in touch with Daniel Noble (daniel.noble@anu.edu.au) and Mike Kearney (m.kearney@unimelb.edu.au) if you have any questions about the code or the models.

# **Introduction**

Here, we develop five hypothetical case studies to demonstrate how a systems modelling approach can be applied in practice. Our case studies focus on plant-insect interactions, and how these interactions are influenced by extreme heat events. 
...
```{r, test_damage_repair}
#| label: test_damage_repair
#| echo: true
#| warning: false
#| message: false 
#| code-fold: true
...
We can now have a look at, using the temperatures experienced by the grasshopper during the heatwave, how damage accumulates over time with and without repair (@fig-damage_repair).

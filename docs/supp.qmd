...
## **Case Study 2: Understanding the effects of leaf mirochabitat on insect life-cyles: Linking mircoclimates to dynamic energy budget and population ecology models** {#case2}
...
geom_ribbon(aes(ymin = N_m - sd, ymax = N_m + sd), alpha = 0.3, colour = NA) +
  ...
  scale_colour_viridis_d() + scale_fill_viridis_d() + theme(axis.text = element_text(size = 12), axis.title = element_text(size = 14), legend.position = "none") +   annotation_custom(closed, xmin = 1, xmax = 4, ymin = 7500, ymax = 12000) + ylim(0, 12000) + scale_colour_viridis_d(

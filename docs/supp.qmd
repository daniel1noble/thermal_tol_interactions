...
# Now subset to the desired dates
  temp_combined_sub <- temp_combined %>% filter(datetime > as.POSIXct('2019-01-15') & datetime < as.POSIXct('2019-01-31'))
...
ggplot(temp_combined_sub, aes(x = datetime, y = TA, color = Species)) +
  ...
  theme_classic() + theme( axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), legend.text = element_text(size = 14), legend.position = "none", axis.text = element_text(size = 14), axis.title = element_blank()) +
  scale_colour_viridis_d()

...
# Create a plot of body temperatures for both species with a secondary axis showing the accumulated thermal load for mortality
...
geom_line(aes(x = timeA / 60, y = tbA), color = "#E5D3B3", size = 0.5) +
geom_line(aes(x = timeA / 60, y = damage_w_repairA * 500), color = "red") + 
scale_y_continuous(
    name = "Probability of Survival (Thermal Load Stress)", 
    sec.axis = sec_axis(~ . / 500, name = "Body temperature (°C)")) +
  theme_classic() +
  theme( axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), legend.position = "none", legend.text = element_text(size = 14), axis.text = element_text(size = 14), axis.title = element_blank())  
...
annotate("rect",
           ...
           fill = "red", alpha = 0.2) +
  labs(x = "Time (hours)", y = "Body Temperature (°C)") +
geom_line(aes(x = timeB / 60, y = tbB), color = "#664229", size = 0.5) +
geom_line(aes(x = timeB / 60, y = damage_w_repairB * 500), color = "red") + 
scale_y_continuous(
    name = "Probability of Survival (Thermal Load Stress)", 
    sec.axis = sec_axis(~ . / 500, name = "Body temperature (°C)")) +
  theme_classic() +
  theme( axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1), legend.position = "none", legend.text = element_text(size = 14), axis.text = element_text(size = 14), axis.title = element_blank(), axis.text.y.left = element_blank())  
...
# A Detailed Guided Introduction to Code in the Boxes

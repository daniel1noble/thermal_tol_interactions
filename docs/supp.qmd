...
#| fig-cap: "Accumulation of physiological damage (%) in grasshoppers during a heatwave event near Renmark, South Australia. Damage accumulation is shown for two scenarios, one where no repair occurs (black line) and one where high repair occurs (orange line). The dashed horizontal line indicates 100% damage, which is the threshold for mortality."
#| code-fold: true
...
p3 <- ggplot2::ggplot() +
  ...
  xlim(0, lim) +
  theme_classic()
(p1 | p2 | p3 ) + plot_annotation(title = "Damage accumulation and repair in grasshoppers during heatwave event")
